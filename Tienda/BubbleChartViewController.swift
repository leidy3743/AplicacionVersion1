...
class BubbleChartViewController: UIViewController, ChartViewDelegate {
    ...
    func setChart(dataPoints: [String], values1: [Double], values2: [Double], values3: [Double]) {
        ...
        let chartData1 = BubbleChartDataSet(yVals: dataEntries1, label: "Datos1")
        let chartData2 = BubbleChartDataSet(yVals: dataEntries2, label: "Datos2")
        let chartData3 = BubbleChartDataSet(yVals: dataEntries3, label: "Datos3")
        
        let chartDataSet: [BubbleChartDataSet] = [chartData1, chartData2, chartData3]
        let chartData = BubbleChartData(xVals: disciplina, dataSets: chartDataSet)
